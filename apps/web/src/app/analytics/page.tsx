...
export default function Analytics() {
  ...
  const providerChartData = Object.entries(providerDataMap).map(
    ...
    },
    {
      ...
      value:
        usageLog && usageLog.length > 0
          ? `${Math.round(usageLog.reduce((acc: number, l: any) => acc + l.latencyMs, 0) / usageLog.length)}ms`
          : "0ms",
      icon: Activity,
