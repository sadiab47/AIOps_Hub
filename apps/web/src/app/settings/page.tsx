    ...
    <ConsoleLayout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">Configure organizations, profiles, and tokens</p>
        </div>
        ...
        <div className="space-y-6 max-w-2xl">
          ...
          <div className="p-6 rounded-2xl border border-white/[0.06] bg-white/[0.01]">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-1.5">Workspace Name</label>
                <input
                  type="text"
                  disabled
          ...
          <div className="p-6 rounded-2xl border border-red-500/10 bg-red-500/[0.02]">
            ...
            <p className="text-xs text-zinc-500 mb-6 leading-relaxed">Deleting this organization will permanently clear all agent registries, version history, prompt templates, and execution traces. This action is irreversible.</p>
