...
export class AuthController {
  ...
  @ApiResponse({
    ...
    headers: {
      "Set-Cookie": {
        description:
          "Attaches aiops_access_token and aiops_refresh_token cookies.",
        schema: { type: "string" },
      },
    },
  })
  ...
  @ApiResponse({
    ...
    headers: {
      "Set-Cookie": {
        description:
          "Attaches namespaced aiops_access_token and aiops_refresh_token session cookies.",
        schema: { type: "string" },
      },
    },
  })
  @ApiResponse({
    status: 400,
    description: "Validation or invalid request parameters.",
  })
  ...
  @ApiResponse({
    ...
    headers: {
      "Set-Cookie": {
        description:
          "Overwrites namespaced aiops_access_token and aiops_refresh_token session cookies.",
        schema: { type: "string" },
      },
    },
  })
  ...
  @HttpCode(200)
  @ApiOperation({
    summary: "Log out from current session and clear auth cookies",
  })
  @ApiCookieAuth("aiops_refresh_token")
  @ApiResponse({
    status: 200,
    description:
      "Current session invalidated and auth cookies cleared (idempotent).",
    headers: {
      "Set-Cookie": {
        description:
          "Clears namespaced aiops_access_token and aiops_refresh_token cookies.",
        schema: { type: "string" },
      },
    },
  })
  ...
  @ApiResponse({
    status: 200,
    description:
      "All active user sessions invalidated and auth cookies cleared (idempotent).",
    headers: {
      "Set-Cookie": {
        description:
          "Clears namespaced aiops_access_token and aiops_refresh_token cookies.",
