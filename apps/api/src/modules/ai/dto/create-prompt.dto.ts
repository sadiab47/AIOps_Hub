...
export class CreatePromptDto {
  @ApiProperty({
    example: "Customer Support Welcome",
  ...
  @ApiPropertyOptional({
    example: "A prompt to greet customers and set expectations",
  ...
  @ApiProperty({
    example: "11a1111a-1111-1111-1111-111111111111",
  ...
  @ApiProperty({
    ...
    example: PromptVisibility.ORGANIZATION,
  ...
  @ApiProperty({
    example: "Hello {{customerName}}, welcome to {{company}}!",
    description: "Mustache/Handlebars template body",
  })
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    description: "Version changelog comment",
  })
  @IsOptional()
  @IsString()
  changeLog?: string;
