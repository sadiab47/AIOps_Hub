...
export class AgentVersionDto {
  ...
  @ApiPropertyOptional({
    description: "Linked prompt library template version ID",
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Execution timeout limit in milliseconds",
  })
  @IsNumber()
  @Min(500)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Flag enabling SSE execution responses stream",
  })
  @IsOptional()
  streamingEnabled?: boolean;

  @ApiPropertyOptional({
    description: "Custom strategy to compute sliding window budget",
  })
  @IsString()
  @IsOptional()
