...
export class AiProvidersController {
  ...
  @ApiResponse({
    status: 201,
    description: "Provider configuration created and validated successfully.",
  })
  @ApiResponse({
    status: 400,
    description: "Credential validation failed or malformed input.",
  })
  @ApiResponse({ status: 401, description: "Unauthenticated." })
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires provider.create permission.",
  })
  @ApiResponse({
    status: 409,
    description: "Duplicate provider configuration name in organization.",
  })
  async create(
  ...
  @ApiOperation({
    summary: "List all AI provider configurations for active organization",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires provider.view permission.",
  })
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires provider.update permission.",
  })
  @ApiResponse({
    status: 404,
    description: "Provider configuration not found.",
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires provider.delete permission.",
  })
  @ApiResponse({
    status: 404,
    description: "Provider configuration not found.",
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: "Test and validate stored credentials against provider endpoint",
  })
  @ApiParam({ name: "id", type: String, format: "uuid" })
  @ApiResponse({
    status: 200,
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: "Set provider configuration as organization default",
  })
  @ApiParam({ name: "id", type: String, format: "uuid" })
  @ApiResponse({
    status: 200,
    description: "Provider set as organization default.",
  })
  @ApiResponse({ status: 401, description: "Unauthenticated." })
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires provider.setDefault permission.",
  })
  @ApiResponse({
    status: 404,
    description: "Provider configuration not found.",
