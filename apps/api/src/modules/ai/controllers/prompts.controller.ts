...
export class PromptsController {
  ...
  @ApiResponse({
    status: 201,
    description: "Prompt and initial version created successfully.",
  })
  @ApiResponse({
    status: 400,
    description: "Invalid validation or missing template.",
  })
  @ApiResponse({
    status: 403,
    description: "Forbidden — requires prompt.create permission.",
  })
  async create(
  ...
  @ApiOperation({
    summary:
      "Get details of a single prompt template including active version variables",
  })
  @ApiParam({ name: "id", type: String, format: "uuid" })
  @ApiResponse({
    status: 200,
    description: "Prompt metadata and variables retrieved.",
  })
  ...
  @ApiOperation({
    summary: "Update prompt metadata (name, description, visibility, category)",
  })
  @ApiParam({ name: "id", type: String, format: "uuid" })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 200,
    description: "Rendered text and validation diagnostic information.",
  })
  async render(
    @TenantId() orgId: string,
    @Param("id", ParseUUIDPipe) id: string,
