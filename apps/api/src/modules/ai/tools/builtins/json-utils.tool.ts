...
export class JsonUtilsTool implements AgentTool {
  readonly definition: ToolDefinition = {
    name: "json_utilities",
    description:
      "Utility for safely parsing JSON strings, format/prettify JSON objects, or minifying JSON strings.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        payload: {
          type: "string",
          description:
            "A JSON string (required for parse) or any serialized data string (required for stringify/minify).",
        },
        spaces: {
          type: "integer",
          minimum: 0,
